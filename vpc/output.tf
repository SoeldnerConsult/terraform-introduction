...
output "subnets_secondary_ranges" {
  value       = module.test-vpc-module.subnets_secondary_ranges[0]
  description = "The secondary ranges associated with these subnets"
}

output "pod_cidr_name" {
  value       = lookup(element(flatten(element(module.test-vpc-module.subnets_secondary_ranges,0)),0),"range_name")
  description = "The routes associated with this VPC"
}

output "service_cidr_name" {
  value       = lookup(element(flatten(element(module.test-vpc-module.subnets_secondary_ranges,0)),1),"range_name")
  description = "The routes associated with this VPC"
}
